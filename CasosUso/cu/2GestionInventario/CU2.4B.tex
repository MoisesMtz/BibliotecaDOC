...
\begin{UseCase}{CU2.4B}{Consultar TT}{
	Se podrá consultar la información de un TT previamente registrado en la biblioteca.
}
		\UCitem{Versión}{0.1}
		\UCitem{Actor}{Procesos Técnicos}
		\UCitem{Propósito}{Mostrar la información de un TT que ha sido registrado en la biblioteca.}
		\UCitem{Entradas}{
			\begin{itemize}
		   		\item Número de TT
		  	\end{itemize}					
		...
		\UCitem{Precondiciones}{ 
			\begin{itemize} 
				...
				\item El TT a consultar debe haber sido registrado anteriormente
			\end{itemize}
		}
...
\begin{UCtrayectoria}{Principal}
		\UCpaso[\UCactor] Proporciona el Número del TT en el campo mostrado en pantalla \IUref{IU2.C1B}{ConsultarTT}
