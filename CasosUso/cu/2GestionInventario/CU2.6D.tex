...
\begin{UseCase}{CU2.6D}{Modificar equipo de Computo}{
	Este caso de uso se podrá modificar equipo de computo
}
		\UCitem{Versión}{0.2}
		\UCitem{Actor}{Procesos Técnicos}
		\UCitem{Propósito}{La información del equipo de computo que se desea modificar será almacenada en el catálogo }
		\UCitem{Entradas}{
			\begin{itemize}
		...
		\UCitem{Salidas}{
			\begin{itemize}
				...
				\begin{itemize}
		   			...
		   			\item \MSGref{MSJ2.1b4}{Modificación exitosa} 
		   		\end{itemize}
		  	\end{itemize} 
		}
		...
		\UCitem{Postcondiciones}{
			\begin{itemize}
				\item Se actualiza la base de datos con la modificación de equipos de computo
			\end{itemize}			
		}
		\UCitem{Autor}{
			\begin{itemize}
...
\begin{UCtrayectoria}{Principal}
		\UCpaso[\UCactor] Proporciona los datos requeridos en los campos que se muestran en la pantalla \IUref{IU2.1bd}{ModificarEqComp}.
