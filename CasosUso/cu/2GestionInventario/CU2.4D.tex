...
\begin{UseCase}{CU2.4D}{Consultar Equipo de Cómputo}{
	Se podrá consultar la información de un material de tipo Equipo de Cómputo previamente registrado en la biblioteca.
}
		\UCitem{Versión}{0.1}
		\UCitem{Actor}{Procesos Técnicos}
		\UCitem{Propósito}{Mostrar la información de un Equipo de Cómputo que ha sido registrado en la biblioteca.}
		\UCitem{Entradas}{
			\begin{itemize}
...
\begin{UCtrayectoria}{Principal}
		\UCpaso[\UCactor] Proporciona el Número de la computadora en el campo mostrado en pantalla \IUref{IU2.C1C}{ConsultarEquipoDeComputo}
