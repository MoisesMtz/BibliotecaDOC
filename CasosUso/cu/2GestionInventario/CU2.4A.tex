...
\begin{UseCase}{CU2.4A}{Consultar libro}{
	Se podrá consultar la información de un libro previamente registrado en la biblioteca.
}
		\UCitem{Versión}{0.1}
		\UCitem{Actor}{Procesos Técnicos}
		\UCitem{Propósito}{Mostrar la información de un libro que ha sido registrado en la biblioteca.}
		\UCitem{Entradas}{
			\begin{itemize}
		   		\item ISBN del libro
		  	\end{itemize}					
		...
		\UCitem{Precondiciones}{ 
			\begin{itemize} 
				...
				\item El libro a consultar debe haber sido registrado anteriormente
			\end{itemize}
		}
...
\begin{UCtrayectoria}{Principal}
		\UCpaso[\UCactor] Proporciona el ISBN del libro en el campo mostrado en pantalla \IUref{IU2.C1A}{ConsultarLibro}
