...
%Introducir los correspondientes a la GESTIÓN DE USUARIOS
  ...
  \cdtLabel{C4.1}{Lector inscrito en el instituto}
	\UCli Tipo: Restricción (validación).
 ...
 \subsection{C4.2 Lector  registrado en la Biblioteca}
  \cdtLabel{C4.2}{Lector  registrado en la Biblioteca}
	\UCli Tipo: Restricción (validación).
	\UCli Autor: Castañeda Sánchez Miguel Ángel
 ...
 \subsection{C4.3 Formato llenado correctamente}
  \cdtLabel{C4.3}{Formato llenado correctamente}
	\UCli Tipo: Restricción (validación).
	\UCli Autor: Castañeda Sánchez Miguel Ángel
 ...
 \subsection{C4.4 Identificación del Lector}
  \cdtLabel{C4.4}{Identificación del Lector}
	\UCli Tipo: Restricción (validación).
	\UCli Autor: Castañeda Sánchez Miguel Ángel
 ...
 \subsection{C4.5 El Lector tiene multas}
  \cdtLabel{C4.5}{El Lector tiene multas}
	\UCli Tipo: Restricción (validación).
	\UCli Autor: Castañeda Sánchez Miguel Ángel
	\UCli Descripción: Validar que el Lector no tenga multas ocasionadas por entregar algún material fuera de tiempo.

 \subsection{C4.6 El Lector tiene adeudos}
  \cdtLabel{C4.6}{El Lector tiene adeudos}
	\UCli Tipo: Restricción (validación).
	\UCli Autor: Castañeda Sánchez Miguel Ángel
...
\cdtLabel{C5.1}{Cobro por reposición de credencial}
	\UCli Tipo: Restricción (validación).
...
\cdtLabel{C5.2}{Verificar identidad}
	\UCli Tipo: Restricción (validación).
	\UCli Autor: Daniel Mora
...
\cdtLabel{C5.4}{Horario de atención del trámite}
	\UCli Tipo: Restricción (validación).
	\UCli Autor: Daniel Mora
...
\cdtLabel{C5.5}{Meses de tramite}
	\UCli Tipo: Restricción (validación).
	\UCli Autor: Daniel Mora
