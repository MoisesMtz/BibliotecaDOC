...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Datos del proyecto
\sistema{Análisis de los Procesos de la Biblioteca de ESCOM}

\proyecto[SGB]{Sistema de Gestión Bibliotecaria}

\documento{Inicial}{Externo}{3CM2}{Análisis de los Procesos de la Biblioteca de ESCOM}{1.0}

\fecha{\today}

\organizacion{Biblioteca de ESCOM}

\author{Escuela Superior de Cómputo del IPN}

\elaboro[Líder de proyecto IPN-ESCOM]{Josué Durán Martínes.}   % Responsable del contenido (IPN)
...
%Introducir los correspondientes a la GESTIÓN DE EMPLEADOS
		\input{procesos/C1_Empleados/GestionPersonal}	
		\input{procesos/C1_Empleados/RegistrarPersonal}	
		\input{procesos/C1_Empleados/ModificarPersonal}
		\input{procesos/C1_Empleados/EliminarPersonal}	


%====================CELULA2=====================================
%Introducir los correspondientes a la GESTIÓN DE INVENTARIO
		\input{procesos/C2_Inventario/adquirirLibros}
		\input{procesos/C2_Inventario/cotejarExistencias}
		\input{procesos/C2_Inventario/cotejarExistenciasEquipo}	
		\input{procesos/C2_Inventario/Descarte}	
		%\input{procesos/C2_Inventario/ReposicionLibro}


%====================CELULA3=====================================
%Introducir los correspondientes a la GESTIÓN DE PRÉSTAMOS

		\input{procesos/C3/prestamo}
		\input{procesos/C3/prestamoi}
		\input{procesos/C3/multas}
		\input{procesos/C3/devolucion}

%====================CELULA4=====================================
%Introducir los correspondientes a la GESTIÓN DE USUARIOS
		\input{procesos/C4_Usuarios/darDeAlta}		
		\input{procesos/C4_Usuarios/darDeBaja}
		\input{procesos/C4_Usuarios/ActualizarLector}
		\input{procesos/C4_Usuarios/consultar}
		\input{procesos/C4/Macroproceso}
		 %Consultar Usuario


%====================CELULA5=====================================
%Introducir los correspondientes a la GESTIÓN DE CREDENCIALES
		\input{procesos/C5_Credenciales/proceso1}		
		\input{procesos/C5_Credenciales/proceso2}
		\input{procesos/C5_Credenciales/proceso3}
